...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_flash0_anti_rollback_counter_increment_guard(flash_ctrl_t *const p_api_ctrl,
        flash_arc_t counter);

BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_flash0_anti_rollback_counter_refresh_guard(flash_ctrl_t *const p_api_ctrl,
        flash_arc_t counter);

BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_flash0_anti_rollback_counter_read_guard(flash_ctrl_t *const p_api_ctrl,
        flash_arc_t counter, uint32_t *const p_count);

BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_flash0_user_lockable_area_write_guard(flash_ctrl_t *const p_api_ctrl,
