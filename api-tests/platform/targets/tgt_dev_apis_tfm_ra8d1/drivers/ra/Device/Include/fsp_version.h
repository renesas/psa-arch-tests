...
/** Public FSP version name. */
 #define FSP_VERSION_STRING          ("5.0.0-beta1+20231002.e82d9f17")

/** Unique FSP version ID. */
 #define FSP_VERSION_BUILD_STRING    ("Built with Renesas Advanced Flexible Software Package version 5.0.0-beta1+20231002.e82d9f17")
