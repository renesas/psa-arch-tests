...
/** Public FSP version name. */
 #define FSP_VERSION_STRING          ("5.5.0-beta2+20240807.33ca5754")

/** Unique FSP version ID. */
 #define FSP_VERSION_BUILD_STRING    ("Built with Renesas Advanced Flexible Software Package version 5.5.0-beta2+20240807.33ca5754")
